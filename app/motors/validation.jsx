    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.wrapper}>
                ...
                <TextInput autoCapitalize={"characters"} maxLength={10} onChangeText={newText => setSerial_no(newText)} placeholderTextColor={"#686D76"} placeholder='eg: DP123456U12345B' style={styles.input} />
